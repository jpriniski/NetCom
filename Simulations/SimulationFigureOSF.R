...
setwd("/Users/hunter/Desktop/Work Projects/NetCom-main/Network Structure Experiments/Context Aware Agents/")


data <- read_csv('EntropyComparisonFigPNAS_UPDATE.csv')
